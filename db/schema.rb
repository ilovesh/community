...
ActiveRecord::Schema.define(:version => 20130204034452) do
  ...
  add_index "likes", ["user_id", "likeable_id", "likeable_type"], :name => "fk_one_like_per_user_per_entity", :unique => true
